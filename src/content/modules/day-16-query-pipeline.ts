  ...
  challenge: {
    ...
    tasks: [
      ...
      },
      {
        ...
        primaryTable: 'customers',
        secondaryTables: ['orders'],
        initialSql: '-- Challenge: customer loyalty tiers\n',
        ...
        solutionExplanation: 'LEFT JOIN preserves zero-order customers, GROUP BY computes the per-customer order count, and CASE in the SELECT clause assigns the loyalty tier based on that aggregate.',
        hints: [{ level: 1, text: 'The CASE condition references COUNT(o.order_id) directly because aggregation runs before projection in the 7-step model.' }],
        validation: {
          requireExactResult: true,
          targetTable: 'customers',
        ...
        successMessage: 'The 7-step pipeline in full glory: LEFT JOIN + GROUP BY + aggregate + CASE projection verified!',
      },
    ],
  },
};
