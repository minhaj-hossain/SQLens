    ...
    // =========================================================================
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          initialSql: '-- Sort customers alphabetically\n',
      ...
      tasks: [
        {
          ...
          type: 'guided',
          primaryTable: 'customers',
          initialSql: 'SELECT DISTINCT city\nFROM customers;',
        ...
        },
        {
          ...
          type: 'independent',
          primaryTable: 'products',
          initialSql: '-- Find all unique category IDs\n',
      ...
      tasks: [
        {
          ...
          type: 'guided',
          primaryTable: 'products',
          initialSql: 'SELECT name, quantity_in_stock\nFROM products\nORDER BY quantity_in_stock ASC\nLIMIT 5;',
      ...
      tasks: [
        {
          ...
          type: 'guided',
          primaryTable: 'products',
          initialSql: 'SELECT name, quantity_in_stock, reorder_level\nFROM products\nWHERE quantity_in_stock <= reorder_level;',
      ...
      tasks: [
        {
          ...
          type: 'guided',
          primaryTable: 'products',
          initialSql: 'SELECT name, price AS unit_cost\nFROM products\nWHERE price > 30\nORDER BY unit_cost DESC\nLIMIT 5;',
      ...
      tasks: [
        {
          ...
          initialSql: 'SELECT * FROM suppliers;',
