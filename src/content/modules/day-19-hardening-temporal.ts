  ...
  challenge: {
    ...
    tasks: [
      ...
      },
      {
        ...
        solutionExplanation: 'Arif, Nadia and Jahid have no orders (last_order NULL — the LEFT JOIN zero-state); Sabrina\'s last order (2026-07-01) is 54 days back — inside the window. HAVING filters groups after aggregation.',
        hints: [
          { level: 1, text: 'MAX(o.order_date) is the last order; the NULL case needs OR MAX(o.order_date) IS NULL because NULL fails comparison.' },
        ],
        validation: {
          requireExactResult: true,
          targetTable: 'customers',
        ...
        successMessage: 'Inactive account temporal audit complete — zero-state handling with relative date boundaries verified!',
      },
    ],
  },
};
