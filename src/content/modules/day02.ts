  ...
  concepts: [
    ...
    // =========================================================================
    {
      ...
      tasks: [
        {
          id: 'day02-c2-t1',
          title: 'Task 1: Premium Products ($100 or more)',
          description: 'Show the name and price of products priced at $100.00 or more from the products table.',
          instructions: [
            'Select `name` and `price` from `products`.',
            'Filter rows where `price >= 100.00`.',
            'End with a semicolon (;).',
          ],
          type: 'guided',
          primaryTable: 'products',
          ...
          hints: [
            { level: 1, text: 'Add `100.00` after `price >=`.' },
            { level: 2, text: '`SELECT name, price FROM products WHERE price >= 100.00;`' },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'price'],
            requireWhere: true,
            whereContainsTerms: ['price', '>=', '100'],
            expectedRowCount: 6,
          },
    ...
    // =========================================================================
    {
      ...
      tasks: [
        ...
        {
          id: 'day02-c3-t2',
          title: 'Task 2: Find London customers',
          description: 'The sales team needs a list of all customers located in London.',
          instructions: [
            'Query the `customers` table.',
            'Select `name`, `email`, and `city`.',
            "Filter for customers where `city = 'London'`.",
          ],
          type: 'independent',
          primaryTable: 'customers',
          initialSql: '-- Find all customers in London\n',
          solutionSql: "SELECT name, email, city FROM customers WHERE city = 'London';",
          solutionExplanation: "`WHERE city = 'London'` returns Elena Rostova and Marcus Vance.",
          hints: [
            { level: 1, text: "`SELECT name, email, city FROM customers WHERE city = 'London';`" },
          ],
          validation: {
            targetTable: 'customers',
            requiredColumns: ['name', 'email', 'city'],
            requireWhere: true,
            whereContainsTerms: ['city', '=', 'London'],
            expectedRowCount: 2,
          },
          successMessage: 'Spot on! Both London customer records retrieved.',
        },
      ],
    },
  ],
    ...
    tasks: [
      {
        ...
        solutionExplanation: '`WHERE price < 50` selects the 9 products priced strictly under $50.',
        hints: [
        ...
        successMessage: 'Task 1 completed! 9 products under $50 retrieved.',
      },
      {
        id: 'day02-hw-2',
        ...
        solutionExplanation: '`WHERE quantity_in_stock > 20` retrieves well-stocked items (7 products).',
        hints: [
        ...
        successMessage: 'Task 2 completed! 7 well-stocked items found.',
      },
      {
        id: 'day02-hw-3',
        ...
        solutionExplanation: '`WHERE quantity_in_stock = 0` identifies products with zero inventory (2 products: Wireless Charging Pad and Steel Frame Footrest).',
        hints: [
      ...
      {
        id: 'day02-hw-4',
        title: 'Task 4: Find all customers in Boston',
        description: 'Retrieve name, email, and city of all customers residing in Boston.',
        instructions: [
        ...
        type: 'challenge',
        primaryTable: 'customers',
        initialSql: '-- Task 4: Customers in Boston\n',
        solutionSql: "SELECT name, email, city FROM customers WHERE city = 'Boston';",
        solutionExplanation: "`WHERE city = 'Boston'` selects David Miller and Sophia Chen (2 customers).",
        hints: [
          { level: 1, text: "Write `SELECT name, email, city FROM customers WHERE city = 'Boston';`" },
        ],
        validation: {
          targetTable: 'customers',
          requiredColumns: ['name', 'email', 'city'],
          requireWhere: true,
          whereContainsTerms: ['city', '=', 'Boston'],
          expectedRowCount: 2,
        },
        successMessage: 'Task 4 completed! Boston customer records retrieved.',
      },
      {
        id: 'day02-hw-5',
        title: 'Task 5: Luxury products ($200 or more)',
        description: 'Find all luxury items in the catalog priced at $200.00 or higher.',
        instructions: [
          'Select `name`, `price`, and `quantity_in_stock` from `products`.',
          'Filter where `price >= 200.00`.',
          'End with a semicolon (;).',
        ],
        type: 'challenge',
        primaryTable: 'products',
        initialSql: '-- Task 5: Luxury items ($200+)\n',
        solutionSql: 'SELECT name, price, quantity_in_stock FROM products WHERE price >= 200.00;',
        solutionExplanation: '`WHERE price >= 200.00` finds the 3 highest tier catalog items (Ergonomic Desk Chair, 4K Monitor, Adjustable Standing Desk).',
        hints: [
          { level: 1, text: 'Use `WHERE price >= 200.00;`' },
        ],
        validation: {
          targetTable: 'products',
          requiredColumns: ['name', 'price', 'quantity_in_stock'],
          requireWhere: true,
          whereContainsTerms: ['price', '>=', '200'],
          expectedRowCount: 3,
        },
        successMessage: 'Task 5 completed! Luxury items identified.',
      },
    ],
  },
};
