    ...
    // =========================================================================
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Use `WHERE price > 50 AND quantity_in_stock > 10;`' },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'price', 'quantity_in_stock'],
            requireWhere: true,
            whereContainsTerms: ['price', '>', '50', 'AND', 'quantity_in_stock', '>', '10'],
            expectedRowCount: 2,
          },
      ...
      tasks: [
        {
          ...
          hints: [
            { level: 1, text: "Write `WHERE city = 'Dhaka' OR city = 'Gazipur';`" },
          ],
          validation: {
            targetTable: 'students',
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Use `WHERE price < 10 OR quantity_in_stock > 50;`' },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'price', 'quantity_in_stock'],
            requireWhere: true,
            whereContainsTerms: ['price', '<', '10', 'OR', 'quantity_in_stock', '>', '50'],
            expectedRowCount: 5,
          },
      ...
      tasks: [
        {
          ...
          hints: [
            { level: 1, text: "Write `WHERE NOT (city = 'Dhaka');`" },
          ],
          validation: {
            targetTable: 'students',
            requiredColumns: ['name', 'city'],
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Use `WHERE NOT (category_id = 1);`' },
          ],
          validation: {
            targetTable: 'products',
      ...
      tasks: [
        {
          ...
          hints: [
            { level: 1, text: 'Wrap `(category_id = 1 OR category_id = 2)` in parentheses.' },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'category_id', 'price'],
            requireWhere: true,
            whereContainsTerms: ['price', '>', '50', 'category_id', '1', 'OR', '2'],
            expectedRowCount: 2,
          },
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Wrap the OR condition in parentheses: `(category_id = 1 OR category_id = 2)`' },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'category_id', 'price'],
            requireWhere: true,
            whereContainsTerms: ['price', '<', '20', 'category_id', '1', 'OR', '2'],
            expectedRowCount: 4,
          },
    ...
    // =========================================================================
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Write `SELECT name, age FROM students WHERE age BETWEEN 20 AND 22;`' },
          ],
          validation: {
            targetTable: 'students',
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Write `SELECT name, price FROM products WHERE price BETWEEN 15.99 AND 65.00;`' },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'price'],
      ...
      tasks: [
        {
          ...
          hints: [
            { level: 1, text: "Write `WHERE city IN ('Dhaka', 'Chattogram');`" },
          ],
          validation: {
            targetTable: 'students',
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Use `WHERE category_id IN (1, 2);`' },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'category_id', 'price'],
    ...
    // =========================================================================
    {
      ...
      theory: {
        ...
        introTable: {
          ...
          rows: [
            ...
            [4, 'Mechanical Keyboard', 65.00],
            [25, 'Wireless Doorbell', 38.00],
            [26, 'Wireless Earbuds', 32.00],
          ],
        },
        explanation: [
      ...
      tasks: [
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: "Use `WHERE name LIKE '_SB%';`" },
          ],
          validation: {
            targetTable: 'products',
            requiredColumns: ['name', 'price'],
    ...
    // =========================================================================
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Use `WHERE contact_email IS NOT NULL;`' },
          ],
          validation: {
        ...
        },
        {
          ...
          hints: [
            { level: 1, text: 'Replace `= NULL` with `IS NULL`.' },
          ],
          validation: {
            targetTable: 'customers',
            requiredColumns: ['name', 'city'],
  ...
  challenge: {
    ...
    tasks: [
      ...
      },
      {
        ...
        hints: [
          { level: 1, text: "Write `WHERE city IN ('Dhaka', 'Chittagong', 'Sylhet');`" },
        ],
        validation: {
          targetTable: 'customers',
      ...
      },
      {
        ...
        hints: [
          { level: 1, text: "Use `WHERE name LIKE 'Wireless%';`" },
        ],
        validation: {
          targetTable: 'products',
          requiredColumns: ['name', 'price', 'quantity_in_stock'],
      ...
      },
      {
        ...
        hints: [
          { level: 1, text: 'Wrap categories in parentheses: `(category_id = 1 OR category_id = 5) AND price < 50 AND quantity_in_stock > 0;`' },
        ],
        validation: {
          targetTable: 'products',
          requiredColumns: ['name', 'category_id', 'price', 'quantity_in_stock'],
          requireWhere: true,
          whereContainsTerms: ['category_id', '1', 'OR', '5', 'AND', 'price', '50', 'quantity_in_stock'],
          expectedRowCount: 7,
        },
