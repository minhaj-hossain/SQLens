    ...
    // =========================================================================
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          solutionExplanation: "Returns domestic customers in Dhaka, Chittagong, and Sylhet.",
          hints: [
  ...
  challenge: {
    ...
    tasks: [
      ...
      },
      {
        ...
        solutionSql: 'SELECT name, city FROM customers WHERE email IS NULL;',
        solutionExplanation: 'Identifies customers without recorded email.',
        hints: [
          { level: 1, text: 'Use `WHERE email IS NULL;`' },
        ],
        validation: {
      ...
      },
      {
        ...
        type: 'challenge',
        primaryTable: 'products',
        initialSql: '-- Task 5: In-stock Electronics or Home under $100\n',
        ...
        solutionExplanation: 'Returns all in-stock products in categories 1 and 5 priced under $100.',
        hints: [
